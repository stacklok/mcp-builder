...
The mcp-builder community takes security seriously! We appreciate your
...
["Report a Vulnerability"](https://github.com/stacklok/mcp-builder/security/advisories/new)
tab.
...
The mcp-builder community asks that all suspected vulnerabilities be
...
- Create a new
  ...
  `https://github.com/stacklok/mcp-builder/security/advisories/new`
